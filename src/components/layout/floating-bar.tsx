 ...
 * once the sidebar is collapsed/closed.
 */
export function FloatingBar() {
    ...
    return (
        <div
            ...
            className="fixed top-3 left-3 z-30 flex items-center gap-1 rounded-xl border border-foreground/8 bg-sidebar/60 p-1 shadow-sm backdrop-blur-md transition-all duration-200 data-[hidden=true]:pointer-events-none data-[hidden=true]:-translate-x-1 data-[hidden=true]:opacity-0"
        >
